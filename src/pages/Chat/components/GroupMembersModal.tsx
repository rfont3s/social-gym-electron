          ...
          {isAdmin && (
            <div className='mb-4'>
              ...
              {isSearching ? (
                ...
                <div className='mt-2 space-y-1 max-h-48 overflow-y-auto border border-gray-200 rounded-lg'>
                  {searchResults.map(user => (
                    <div
                      key={user.id}
                      className='flex items-center justify-between p-2 hover:bg-blue-50 transition-colors cursor-pointer'
                    ...
                    >
                      ...
                      <button
                        disabled={isAdding}
                        className='p-1 text-blue-600 hover:bg-blue-100 rounded-full transition-colors disabled:opacity-50 flex-shrink-0'
                        onClick={(e) => {
                          e.stopPropagation();
            ...
            <div className='space-y-2'>
              {conversation.participants?.filter(p => !p.leftAt).map(participant => {
                ...
                return (
                  ...
                  >
                    <div className='flex items-center gap-2'>
                      <div className='w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm relative'>
